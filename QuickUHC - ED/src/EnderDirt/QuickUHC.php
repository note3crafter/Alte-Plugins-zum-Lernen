...
class QuickUHC extends PluginBase implements Listener {
	
	public $prefix = Color::WHITE . "[" . Color::GREEN . "QuickUHC" . Color::WHITE . "] ";
	public $arenaname = "";
	public $mode = 0;
	public $players = 0;
    ...
    public function onInteract(PlayerInteractEvent $event) {
        ...
        if ($this->mode === 1 && $player->isOp()) {
            ...
            $player->sendMessage($this->prefix . "Jetzt den PvP Spawn");
            $this->mode++;
    ...
    public function onBreak(BlockBreakEvent $event) {
        ...
        if ($config->get("ingame") === false) {
        	...
        	if ($block->getId() === 14) {
        	    ...
        	    $event->setDrops(array(Item::get(266, 0, 2)));
        	    
            } else if ($block->getId() === 15) {
        	    
        	    $event->setDrops(array(Item::get(265, 0, 2)));
        	    
            } else if ($block->getId() === 16) {
        	    
        	    $event->setDrops(array(Item::get(263, 0, 2), Item::get(50, 0, 4)));
        	    
            } else if ($block->getId() === 21) {
        	    
        	    $event->setDrops(array(Item::get(351, 4, 4)));
        	    
            } else if ($block->getId() === 56) {
        	    
        	    $event->setDrops(array(Item::get(264, 0, 2)));
        	    
            } else if ($block->getId() === 12) {
        	    
        	    $event->setDrops(array(Item::get(20, 0, 2)));
        	    
            } else if ($block->getId() === 18) {
        	    
        	    $event->setDrops(array(Item::get(260, 0, 2)));
        	    
            } else if ($block->getId() === 17) {
        	    
        	    $event->setDrops(array(Item::get(260, 0, 2), Item::get(5, 0, 8)));
    ...
    public function giveKit(Player $player) {
    	...
    	$player->getInventory()->clearAll();
        $player->getInventory()->setItem(0, Item::get(257, 0, 1));
        $player->getInventory()->setItem(0, Item::get(320, 0, 12));
            ...
            if ($this->plugin->players >= 2) {
                ...
                if ($time % 5 === 0 && $time > 0) {
                    ...
                    foreach ($all as $player) {
                        ...
                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Die Farm Zeit endet in " . Color::DARK_PURPLE . "10" . Color::WHITE . " Minuten!");
                        $player->setHealth(20);
                        $player->setFood(20);
                ...
                foreach ($all as $player) {
                    ...
                    if ($time === 600) {
                     ...
                     if ($time === 900) {
                        ...
                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Die Farm Zeit endet in " . Color::DARK_PURPLE . $time / 60 . Color::WHITE . " Minuten!");

                    } else if ($time === 660) {

                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Die Farm Zeit endet in " . Color::DARK_PURPLE . $time / 60 . Color::WHITE . " Sekunden!");
                        ...
                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Die PvP Zeit endet in " . Color::DARK_PURPLE . $time / 60 . Color::WHITE . " Minuten!");

                    } else if ($time === 60) {

                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Das PvP Zeit endet in " . Color::DARK_PURPLE . $time / 60 . Color::WHITE . " Minuten!");

                    } else if ($time === 1 || $time === 2 || $time === 3 || $time === 4 || $time === 5 || $time === 15 || $time === 30) {

                        $player->sendMessage(Color::DARK_PURPLE . ">> " . Color::WHITE . "Das PvP Zeit endet in " . Color::DARK_PURPLE . $time . Color::WHITE . " Sekunden!");
