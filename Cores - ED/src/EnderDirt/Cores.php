    ...
    public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool {
        ...
        if ($command->getName() === "Start") {
            ...
            if ($pg->get("NickP") === true) {
            	...
            	$sender->sendMessage(Color::RED . "Du hast keine Berechtigung fÃƒÂƒÃ‚Â¼r diesen befehl!");
                ...
                if ($config->get("ingame") === false) {
                	...
                	if ($x === $af->get("sb1x") && $y === $af->get("sb1y") && $z === $af->get("sb1z")) {
                	    ...
                	    if ($player->getName() === $config->get("player1")) {
                            ...
                            $p->sendMessage($this->prefix . Color::GREEN . "Der " . Color::BLUE . "BLAUE" . Color::GREEN . " Rechte Core wurde zerstört!");
                	    ...
                	    if ($player->getName() === $config->get("player1")) {
                            ...
                            $p->sendMessage($this->prefix . Color::GREEN . "Der " . Color::BLUE . "BLAUE" . Color::GREEN . " Linke Core wurde zerstört!");
                	    ...
                	    if ($player->getName() === $config->get("player2")) {
                            ...
                            $p->sendMessage($this->prefix . Color::GREEN . "Der " . Color::RED . "ROTE" . Color::GREEN . " Rechte Core wurde zerstört!");
                	    ...
                	    if ($player->getName() === $config->get("player2")) {
                            ...
                            $p->sendMessage($this->prefix . Color::GREEN . "Der " . Color::RED . "ROTE" . Color::GREEN . " Linke Core wurde zerstört!");
