...
class BedWars extends PluginBase implements Listener {
    ...
    public function onInteract(PlayerInteractEvent $event) {
        ...
        if ($item->getCustomName() === Color::DARK_PURPLE . "Einstellungen") {
            ...
            $pokemon->setCustomName(Color::AQUA . "Platzangst");
            $player->getInventory()->setItem(4, $pokemon);
            
            }
        } else if ($item->getCustomName() === Color::AQUA . "Platzangst") {
        	
        	$config->set("Arena", "Platzangst");
            $config->save();
            $player->sendMessage(Color::WHITE . "Die Map " . Color::GOLD . "Platzangst" . Color::WHITE . " wurde erfolgreich ausgesucht!");
            $player->getInventory()->clearAll();
            $set = Item::get(395, 0, 1);
            $set->setCustomName(Color::DARK_PURPLE . "Einstellungen");
            $player->getInventory()->setItem(4, $set);
        ...
        if ($this->mode === 1 && $player->isOp()) {
            ...
            $player->sendMessage($this->prefix . "Jetzt den 5. Block");
            $this->mode++;
        	...
        	if ($player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()))->getId() == 26) {
        	    ...
        	    $block2 = $player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()));
        	    $af->set("sb5x", $block->getX());
                $af->set("sb5y", $block->getY());
                $af->set("sb5z", $block->getZ());
                $af->set("sb5x1", $block2->getX());
                $af->set("sb5y1", $block2->getY());
                $af->set("sb5z1", $block2->getZ());
                $af->save();
            ...
            $player->sendMessage($this->prefix . "Jetzt den 6. Block");
            $this->mode++;
        	...
        	if ($player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()))->getId() == 26) {
        	    ...
        	    $block2 = $player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()));
        	    $af->set("sb6x", $block->getX());
                $af->set("sb6y", $block->getY());
                $af->set("sb6z", $block->getZ());
                $af->set("sb6x1", $block2->getX());
                $af->set("sb6y1", $block2->getY());
                $af->set("sb6z1", $block2->getZ());
                $af->save();
            ...
            $player->sendMessage($this->prefix . "Jetzt den 7. Block");
            $this->mode++;
        	...
        	if ($player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()))->getId() == 26) {
        	    ...
        	    $block2 = $player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()));
        	    $af->set("sb7x", $block->getX());
                $af->set("sb7y", $block->getY());
                $af->set("sb7z", $block->getZ());
                $af->set("sb7x1", $block2->getX());
                $af->set("sb7y1", $block2->getY());
                $af->set("sb7z1", $block2->getZ());
                $af->save();
            ...
            $player->sendMessage($this->prefix . "Jetzt den 8. Block");
            $this->mode++;
        	...
        	if ($player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()))->getId() == 26) {
        	    ...
        	    $block2 = $player->getLevel()->getBlock(new Vector3($block->getX() + 1, $block->getY(), $block->getZ()));
        	    $af->set("sb8x", $block->getX());
                $af->set("sb8y", $block->getY());
                $af->set("sb8z", $block->getZ());
                $af->set("sb8x1", $block2->getX());
                $af->set("sb8y1", $block2->getY());
                $af->set("sb8z1", $block2->getZ());
                $af->save();
    ...
    public function onBreak(BlockBreakEvent $event) {
        ...
        foreach($player->getLevel()->getPlayers() as $p) {
                ...
                if ($config->get("ingame") === false) {
                    ...
                    if ($x === $af->get("sb1x") && $y === $af->get("sb1y") && $z === $af->get("sb1z")) {
                	    ...
                	    if ($player->getName() === $config->get("player3")) {
                            ...
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player3"));	
                            if (!$p2 == null) {
                	    ...
                	    if ($player->getName() === $config->get("player4")) {
                            ...
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player4"));	
                            if (!$p2 == null) {
                ...
                } else if ($x === $af->get("sb5x") && $y === $af->get("sb5y") && $z === $af->get("sb5z")) {
                	    ...
                	    if ($player->getName() === $config->get("player5")) {
                            ...
                            $p->sendMessage($this->prefix . Color::WHITE . "Das " . Color::GOLD . "ORANGE" . Color::WHITE . " Bett wurde zerstoert!");
                            $config->set("block5", false);
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player5"));	
                            if (!$p2 == null) {
                    ...
                    } else if ($x === $af->get("sb5x1") && $y === $af->get("sb5y1") && $z === $af->get("sb5z1")) {
                ...
                } else if ($x === $af->get("sb6x") && $y === $af->get("sb6y") && $z === $af->get("sb6z")) {
                	    ...
                	    if ($player->getName() === $config->get("player6")) {
                            ...
                            $p->sendMessage($this->prefix . Color::WHITE . "Das " . Color::LIGHT_PURPLE . "PINKE" . Color::WHITE . " Bett wurde zerstoert!");
                            $config->set("block6", false);
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player6"));	
                            if (!$p2 == null) {
                    ...
                    } else if ($x === $af->get("sb6x1") && $y === $af->get("sb6y1") && $z === $af->get("sb6z1")) {
                ...
                } else if ($x === $af->get("sb7x") && $y === $af->get("sb7y") && $z === $af->get("sb7z")) {
                	    ...
                	    if ($player->getName() === $config->get("player7")) {
                            ...
                            $p->sendMessage($this->prefix . Color::WHITE . "Das " . Color::DARK_PURPLE . "LILA" . Color::WHITE . " Bett wurde zerstoert!");
                            $config->set("block7", false);
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player7"));	
                            if (!$p2 == null) {
                    ...
                    } else if ($x === $af->get("sb7x1") && $y === $af->get("sb7y1") && $z === $af->get("sb7z1")) {
                ...
                } else if ($x === $af->get("sb8x") && $y === $af->get("sb8y") && $z === $af->get("sb8z")) {
                	    ...
                	    if ($player->getName() === $config->get("player8")) {
                            ...
                            $p->sendMessage($this->prefix . Color::WHITE . "Das " . Color::BLACK . "SCHWARZE" . Color::WHITE . " Bett wurde zerstoert!");
                            $config->set("block8", false);
                            $config->save();
                            $p2 = $this->getServer()->getPlayerExact($config->get("player8"));	
                            if (!$p2 == null) {
                    ...
                    } else if ($x === $af->get("sb8x1") && $y === $af->get("sb8y1") && $z === $af->get("sb8z1")) {
    ...
    public function onRespawn(PlayerRespawnEvent $event) {
        ...
        if ($player->getName() === $config->get("player1")) {
                	...
                	if ($config->get("block5") === true) {
                	
                	    $this->giveKit($player);
                        $player->teleport(new Position($af->get("s5x"), $af->get("s5y"), $af->get("s5z"), $level));
                
                    } else if ($config->get("block5") === false) {
                	...
                	if ($config->get("block6") === true) {
                	
                	    $this->giveKit($player);
                         $player->teleport(new Position($af->get("s6x"), $af->get("s6y"), $af->get("s6z"), $level));
                
                    } else if ($config->get("block6") === false) {
                	...
                	if ($config->get("block7") === true) {
                	
                	    $this->giveKit($player);
                         $player->teleport(new Position($af->get("s7x"), $af->get("s7y"), $af->get("s7z"), $level));
                
                    } else if ($config->get("block7") === false) {
                	...
                	if ($config->get("block8") === true) {
                	
                	    $this->giveKit($player);
                        $player->teleport(new Position($af->get("s8x"), $af->get("s8y"), $af->get("s8z"), $level));
                
                    } else if ($config->get("block8") === false) {
        	    ...
        	    if ($player->getName() === $config->get("player1")) {
                    ...
                    if ($y <= 0) {
                    	...
                    	if ($config->get("block1") === true) {
                	       ...
                	       $this->plugin->giveKit($player);
                           $player->teleport(new Position($af->get("s1x"), $af->get("s1y"), $af->get("s1z"), $level));
                           $player->sendMessage($this->plugin->prefix . Color::GREEN . $player->getDisplayName() . Color::WHITE . " ist Gestorben!");
                           ...
                           $player->teleport(new Position($af->get("s1x"), $af->get("s1y"), $af->get("s1z"), $level));
                           $this->plugin->players--;
                           $this->plugin->delPlayer($player);
                           $player->sendMessage($this->plugin->prefix . Color::RED . "Du konntest nicht mehr respawnen!");
