        ...
        if ($config->get("ingame") === true) {
            ...
            if ($words[0] === "@a" or $words[0] === "@all") {
            	...
            	if ($player->getName() === $config->get("blau1")) {
            	    ...
            	    $p = $this->getServer()->getPlayerExact($config->get("blau3"));
                    if ($p != null) {
                    ...
                    $p2 = $this->getServer()->getPlayerExact($config->get("blau5"));
                    if ($p2 != null) {
                    	
                    	$p2->sendMessage(Color::WHITE . "[" . Color::BLUE . "Team" . Color::WHITE . "] " . $player->getDisplayName() . " : " . Color::GRAY . $msg);
                    	
                    }
                    
                    $p3 = $this->getServer()->getPlayerExact($config->get("blau7"));
                    if ($p3 != null) {
                    	
                    	$p3->sendMessage(Color::WHITE . "[" . Color::BLUE . "Team" . Color::WHITE . "] " . $player->getDisplayName() . " : " . Color::GRAY . $msg);
                    ...
                    $p2 = $this->getServer()->getPlayerExact($config->get("blau3"));
                    if ($p2 != null) {
                    ...
                    $p3 = $this->getServer()->getPlayerExact($config->get("blau3"));
                    if ($p3 != null) {
                ...
                if ($player->getName() === $config->get("rot2")) {
            	    ...
            	    $p = $this->getServer()->getPlayerExact($config->get("rot4"));
                    if ($p != null) {
                    ...
                    $p2 = $this->getServer()->getPlayerExact($config->get("rot6"));
                    if ($p2 != null) {
                    	
                    	$p2->sendMessage(Color::WHITE . "[" . Color::RED . "Team" . Color::WHITE . "] " . $player->getDisplayName() . " : " . Color::GRAY . $msg);
                    	
                    }
                    
                    $p3 = $this->getServer()->getPlayerExact($config->get("rot8"));
                    if ($p3 != null) {
                    	
                    	$p3->sendMessage(Color::WHITE . "[" . Color::RED . "Team" . Color::WHITE . "] " . $player->getDisplayName() . " : " . Color::GRAY . $msg);
                    ...
                    $p2 = $this->getServer()->getPlayerExact($config->get("rot4"));
                    if ($p2 != null) {
                    ...
                    $p3 = $this->getServer()->getPlayerExact($config->get("rot4"));
                    if ($p3 != null) {
