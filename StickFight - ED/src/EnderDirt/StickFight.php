...
class StickFight extends PluginBase implements Listener {
	...
	public $prefix = Color::WHITE . "[" . Color::GREEN . "StickFight" . Color::WHITE . "] ";
	public $arenaname = "";
	public $mode = 0;
	public $players = 0;
	...
	public function onEnable() {
        ...
        if (is_dir("/home/EnderCloud/StickFight") !== true) {
			
             mkdir("/home/EnderCloud/StickFight");
            
        }
        
        if (is_dir("/home/EnderCloud/StickFight/players") !== true) {
			
             mkdir("/home/EnderCloud/StickFight/players");
    ...
    public function onLogin(PlayerLoginEvent $event) {
        ...
        if (!is_file("/home/EnderCloud/StickFight/players/" . $player->getName() . ".yml")) {
        
            $playerfile = new Config("/home/EnderCloud/StickFight/players/" . $player->getName() . ".yml", Config::YAML);
